...
public class ManageEmployeeJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        for (Organization organization : organizationDir.getOrganizationList()){
            if(!organization.getName().contains(Organization.Type.Building.getValue()))
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        Boolean nameCheck=validator.validateLetters(name);
        
        if(nameCheck)
        {   
        if(organization.getEmployeeDirectory().checkIfEmpnameIsUnique(name))    
        {
        ...
        {
        JOptionPane.showMessageDialog(null,"Invalid data in Name Field");
        }
