...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    @SuppressWarnings("unchecked")
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
            if(!(organization.getClass().getName().contains("Resident")) && !(organization.getClass().getName().contains("Building")))
    ...
    private void populateRoleComboBox(Organization organization){
        ...
        for (Role role : organization.getSupportedRole()){
            if(!role.equals(Role.RoleType.Citizen.getValue()))
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        boolean userNamecheck=organization.getUserAccountDirectory().checkIfUsernameIsUnique(userName);
        if(userNamecheck)
        {
            if(role.toString().contains("MonitoringSupervisor"))
            {
                for(UserAccount ua:organization.getUserAccountDirectory().getUserAccountList())
                if(role.toString().contains(ua.getRole().toString()))
                {JOptionPane.showMessageDialog(null,"Only one Supervisor can exist for this Enterprise!");
                ...
                for(UserAccount ua:organization.getUserAccountDirectory().getUserAccountList()){
                  if(ua.getEmployee()!=null && ua.getEmployee().getName().equals(employee.getName()))  
                  {
                      JOptionPane.showMessageDialog(null,"Employee already has a User Account!");
                      empcheck=true;
