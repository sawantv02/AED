 ...
 * @author vishakha
 */
public class ConsolidatedReportJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private ComplexEnterprise enterprise;
    public ConsolidatedReportJPanel(JPanel userProcessContainer,ComplexEnterprise enterprise) {
        initComponents();
    ...
    public void populateReport()
    {
        ...
        DefaultTableModel model=populateReportTable();
        try {
            JasperCompileManager.compileReportToFile("Reports/report4.jrxml");
            jasperPrint = JasperFillManager.fillReport("Reports/report4.jasper", new HashMap(),
