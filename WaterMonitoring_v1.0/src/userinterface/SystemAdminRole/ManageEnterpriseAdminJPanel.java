...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        boolean checkPass=validator.validatePassword(password);
        boolean checkName=validator.validateLetters(name);
        boolean checkUsername=validator.validateLetters(username);
        //if(!username.trim().isEmpty() && !password.trim().isEmpty() && !name.trim().isEmpty())
        if(checkPass && checkName && checkUsername)
        { 
        if(enterprise.getUserAccountDirectory().checkIfUsernameIsUnique(username))
        {    
         for(UserAccount ua:enterprise.getUserAccountDirectory().getUserAccountList())
             if(ua.getRole().toString().contains(Role.RoleType.Admin.getValue())){
                 JOptionPane.showMessageDialog(null,"Only one Enterprise Admin can exist!");
                 return;
             }
